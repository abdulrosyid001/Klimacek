...
const ProductHero: React.FC<ProductHeroProps> = ({ title, backgroundImage, subtitle }) => (
  <section
  ...
  >
    ...
    <div className="relative z-10">
      ...
      {subtitle && <p className="text-lg md:text-xl text-primary-100 drop-shadow">{subtitle}</p>}
    </div>
  </section>
);
