    ...
    <>
      ...
      <main className="bg-beige min-h-screen py-12 px-4">
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow p-8">
          ...
          <h1 className="font-serif text-2xl font-bold text-primary-900 mb-2">Checkout: {pkg.title}</h1>
          <img src={pkg.image} alt={pkg.title} className="w-32 h-32 object-contain rounded-xl mb-4" />
          <div className="mb-4 text-primary-700">{pkg.features.join(', ')}</div>
          <div className="mb-4 text-primary-900 font-bold text-xl">{pkg.price}</div>
